...
<template>
    <AuthenticatedLayout>
        <div class="mx-auto max-w-3xl rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            <div class="mb-6">
                <h1 class="text-2xl font-semibold text-slate-900 dark:text-white">Create Admin</h1>
                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Add a new administrator account.</p>
            </div>
            ...
            <form class="space-y-5" @submit.prevent="submit">
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <button type="submit" class="rounded-lg bg-amber-500 px-4 py-2 text-sm font-medium text-white hover:bg-amber-600">Save Admin</button>
                </div>
            </form>
        </div>
    </AuthenticatedLayout>
